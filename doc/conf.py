...
version = fluidlab.__version__.split(".")
version = "{}.{}".format(version[0], version[1])
# The full version, including alpha/beta/rc tags.
release = fluidlab.__version__
...
html_short_title = "FluidLab " + release
...
latex_documents = [
    ("index", "fluidlab.tex", "fluidlab Documentation", "Pierre Augier", "manual")
]
