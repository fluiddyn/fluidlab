...
class AgilentDSOX2014a(
    ...
    def get_curve(self, nb_points=1000, format_output="byte"):
        ...
        time = np.array(
            [(s - xreference) * xincrement + xorigin for s in range(nb_points)]
        )
        ...
        if format_output == "ascii":
            ...
            data = np.array(
                [
                    (ord(s) - yreference) * yincrement + yorigin
...
if __name__ == "__main__":
    scope = AgilentDSOX2014a(interface="USB0::2391::6040::MY51450715::0::INSTR")
