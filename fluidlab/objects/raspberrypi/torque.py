...
class TorqueClient(Torque):
    ...
    def _transfer_from_raspberrypi(self, indice_files=None):
        ...
        self.conn.root.torque.copy_files_in_client(indice_files=indice_files)
...
if __name__ == "__main__":
    ...
    # print(volts)
        ...
        exp = load_exp(str_path_save=str_path_save, NEED_BOARD=False)

        torque = TorqueClient(
            path_exp=exp.path_save, name_exp=exp.name_dir, connect=True
        )
