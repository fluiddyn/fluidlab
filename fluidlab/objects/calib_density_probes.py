...
class Calibration(object):
    ...
    def T_from_voltT(self, voltT):
        ...
        tmp = (np.log(voltT-self.voltToff) -
               self.coeffs_temp[1]) / self.coeffs_temp[0]
        Ti = 1./tmp - 273.15
        return Ti
...
if __name__ == '__main__':
    ...
    path = ('/fsnet/project/watu/2017/17MILESTONE/Calibrations/Probes/'
