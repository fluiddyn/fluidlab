...
class InstructionsUVMAT(ParamContainer):
    ...
    def _init_root(self):
        ...
        self._set_attrib("path_dir_output", path_dir_input + self.output_dir_ext)
...
def main():
    ...
    logging.info(
        'Verify if the action "%s" is implemented by FluidDyn', action_name
    )
